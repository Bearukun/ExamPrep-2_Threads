...
/**
 * The RandomUserForm needs to observe the RandomUserControl class, therefore we
...
public class RandomUserForm extends javax.swing.JFrame implements Observer {
    ...
    //Create a new RandomUserControl object.
    RandomUserControl randomUserControl = new RandomUserControl();

    /**
     * The constructor of RandomUserForm
     */
    public RandomUserForm() {

        //We need to add 'this' (our class) as an observer to our
        //RandomUserControl object.
        this.randomUserControl.addObserver(this);
        //This is some method that is premade, swing-magic!
        initComponents();
  ...
  private void btn1Clicked(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1Clicked
      ...
      //Moved to update method, that is comming from the Observer-implementation.
      ...
      //Call the fetchRandomUser method.
